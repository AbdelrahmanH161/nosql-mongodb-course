													...
													<motion.div
														...
														<div className='bg-gradient-to-r from-[#13AA52]/20 to-blue-500/20 border border-[#13AA52]/30 rounded-2xl p-6'>
															...
															<p className='text-gray-600 dark:text-gray-300'>
																Take a 10-minute break before diving into
								...
								<div className='mb-8'>
									...
									<div className='bg-gray-50 dark:bg-gray-700 rounded-xl p-6 mb-6'>
										...
										<p className='text-gray-600 dark:text-gray-300 mb-4'>
											...
											Documents consist of orders. An order has an id (e.g.
											"o1"), the year in which it was issued, the cost, the
											items in the order, and the number of days it took to
											deliver the order. The cost is specified as price in a
											given currency. The order items consist of products. A
											product has an id (e.g., "p1"), colours, and quantity.
										</p>
										<SyntaxHighlighter
											language='javascript'
											style={tomorrow}
									...
									<div className='bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6'>
										...
										<ol className='space-y-4'>
											<li className='text-gray-700 dark:text-gray-300'>
												<strong>1.</strong> Retrieve all documents in a
												collection
											</li>
											<li className='text-gray-700 dark:text-gray-300'>
									...
									<div className='space-y-6'>
										...
										<div className='bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6'>
											...
											<p className='text-gray-700 dark:text-gray-300'>
												Update the student with specific FirstName, and change
												his LastName
											</p>
										</div>

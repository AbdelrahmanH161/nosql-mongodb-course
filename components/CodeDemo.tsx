...
export default function CodeDemo() {
	...
	return (
		<section
			id='demo'
			className='py-12 sm:py-16 lg:py-24 bg-gray-50 dark:bg-gray-800'>
					...
					<div className='lg:hidden space-y-6'>
						...
						<motion.div
							...
							<div className='bg-gray-900 dark:bg-gray-950 rounded-t-xl'>
								<div className='flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-700'>
									<div className='flex items-center space-x-2 sm:space-x-3'>
										...
										<div className='flex items-center space-x-1.5 sm:space-x-2 text-gray-300'>
									...
									<div className='flex items-center space-x-1.5 sm:space-x-2'>
										...
										<button
											onClick={runQuery}
											disabled={isRunning}
											className='flex items-center space-x-1 px-2 sm:px-3 py-1 bg-[#13AA52] hover:bg-[#0F8A42] rounded text-white text-xs sm:text-sm font-medium transition-colors disabled:opacity-50'>
							...
							<motion.div
								...
								<div className='flex items-center space-x-2 px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700'>
									<Database className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#13AA52]' />
									...
									{isRunning && (
										<motion.div
											...
											className='w-3.5 h-3.5 sm:w-4 sm:h-4 border-2 border-[#13AA52] border-t-transparent rounded-full'
										/>
									)}
								</div>
								<SyntaxHighlighter
